...
router.get('/', verifyToken, async (req, res) => {
    try {
        ...
        if (req.query.is_ai_generated) {
            ...
            if (req.query.source_type === 'by-name') {
                query += ` AND r.source_ingredients LIKE 'Generated By Name:%'`;
            } else if (req.query.source_type === 'by-ingredients') {
                query += ` AND (r.source_ingredients IS NULL OR r.source_ingredients NOT LIKE 'Generated By Name:%')`;
            }
        }
